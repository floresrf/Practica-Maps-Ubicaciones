<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmUbicaciones.aspx.cs" Inherits="Practica_1.WebForm1" %>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtLat" Text="27.36689135031209" CssClass="form-control" runat="server"></asp:TextBox>
                        <label for="ExampleInputPassword2">Long.:</label>
                        <asp:TextBox ID="txtLong" Text="-109.93121435887369" CssClass="form-control" runat="server"></asp:TextBox>
                    </div>
